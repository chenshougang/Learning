...
//  功能：接受CAN消息
//  输入：
//  id 消息id-0.6* atan(2 * L * lat_distance / (long_distance * long_distance)) * 180 /
//           M_PI;
//  mes_length 消息长度
//  EFF
//  CAN_channel CAN通道
...
//         }
//         else if(id == VEHICLE_RATE_ID)        // 跟随车横摆角速度
//         {
//             static int CAN_msg[9] = {0};
//             CAN_get_msg(id,EFF,CAN_channel,CAN_msg);
//             if(CAN_msg[8]==1)
...
//         }
//         else if(id == VEHICLE_STEER_ID)      // 跟随车方向盘转角
//         {
//             static int CAN_msg[9]={0};
//             CAN_get_msg(id,EFF,CAN_channel,CAN_msg);
//             if(CAN_msg[8] == 1)
...
//             else
//             {
//                 CAN2Val_Steer_Data(CAN_msg);
//                 //cout<<"steer sucess!"<<endl;
//             }
//         }
...
//  输出：
//  *****************************************************/
// void CANMessage::CAN2Val_Steer_Data(int*CANMsg_Steer_Data)
// {
//     mutex mut;
//     lock_guard<mutex>lock(mut);
//     if(CANMsg_Steer_Data[1]>=0x80)
//     {
//         Follower_steer_angle=(256*CANMsg_Steer_Data[1]+CANMsg_Steer_Data[0]-65536);
//     }
//     else
//     {
//         Follower_steer_angle=(256*CANMsg_Steer_Data[1]+CANMsg_Steer_Data[0]);
//     }
